...
# The dict is the whole lesson, so Check refuses the shortcuts that answer it
# for you: counting is what you are here to write.
for _banned in ("Counter(", "defaultdict(", "collections", ".count"):
